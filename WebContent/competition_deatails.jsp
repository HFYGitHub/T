...
<div class="f2 d-flex text-center ">
    ...
    <div class="f2-item p-4"> <a href="/T/ShowAllNotice?username=${username }&currentPage=0&theme=请选择一个比赛类型" >比赛通知</a>
</div>
...
<%--    <a href="javascript:history.go(-1)" class="offset-6"><button class="btn btn-primary">返回</button></a>--%>
       <c:forEach items="${compeNotice }" var="compe">
        <div class="">
            <a href="/T/ShowQuestionAtMain?username=${username }"><img src="img/icon/zhuye.png"  class="img1"></a>
            <span> > </span>
            <a href="/T/ShowAllNotice?username=${username }&currentPage=0&theme=请选择一个比赛类型">比赛通知</a>
            <span> > </span>
            <span class="n-head border-bottom"><a href="/T/ShowAllNotice?username=${username }&currentPage=0&theme=${compe.theme}">${compe.theme}</a></span>
            <span> > </span>
            <a href="#">${compe.content}</a>
            <hr>
        </div>
        <div class="row border-bottom">
            ...
            <div class="note-info d-flex flex-column col-sm-9 border-bottom" style="padding: 0">
            ...
            <div class="col-sm-11">
                <c:if test="${username eq user_name }">
                    <a class="zan float-right" href="#"> <img alt="删除" class="img-fluid zan-img" src="img/newic/delete.png  " style="width: 30px;height: 30px"></a>
                </c:if>
                <div class="" style="height: 100px;">&emsp;</div>

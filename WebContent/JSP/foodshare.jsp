                    ...
                    <table >
                        ...
                        <tr>
                         <td>   
                            ...
                            <img style="width: 60px;height: 60px;" src="/foodsave/food12.jpg" id="showImg">
                       </td>
                    ...
                    <c:forEach items="${allfood_left}" var="food">
                        <div class="card" style="margin-bottom: 40px">
                            ...
                            <div class="card-footer c-f d-flex flex-row">
                                ...
                                <a href="/T/FoodDetailServlet?food_id=${food.food_id}&introduce=${food.introduce}&img=${food.img_name}&publish_time=${food.release_time}&theme=${food.text}&num=${food.number}&fabulous=${food.fabulous}&username=${username}"
                                   class="view-number"   data-toggle="collapse"><img alt="评论" class="img-fluid" src="img/img/ic/comment-outline.png"></a>

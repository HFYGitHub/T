            ...
            <div class="row u-s-info border-bottom offset-1 col-sm-9">
                ...
                <div class="note-info d-inline-flex flex-column col-sm-11 " style="padding: 0">
                    ...
                    <div id="show" class="d-flex flex-row offset-10" style="padding-right: 20px">
                        <a href="" style="float: right" data-src="#discord" class="view-number" data-toggle="collapse" data-target="#pl" data-rep_name="${answer.name }" data-rep_id="0"  data-anw_id="${answer.answer_id }" data-user_id="${user_id }" data-theme="${theme}" data-question_id="${q_id}">
                            <img alt="讨论" class="img-fluid" src="img/ic/comment-outline.png" style="width: 30px;height: 30px">
                        </a>
                        &emsp;
                        <c:if test="${username eq user_name }">
                            <a class="zan" href="#"> <img alt="点赞" class="img-fluid zan-img" src="img/newic/delete.png  " style="width: 30px;height: 30px"></a>
                        </c:if>
                    </div>
                    <div class="send-info border-bottom collapse" id="pl" >
                        <textarea class="form-control" rows="2" style="resize: none" id="txt2"></textarea>
                        <div class="">
                            <input type="button" class="sub" id="sub2"  value="回复"/>
                        </div>
                    </div>
                    ...
                    <div class="border-bottom col" style="margin-bottom: 10px;background-color: #F4F4F4">
                        <div class="d-flex flex-row">
                            ...
                            <div class="note-info d-inline-flex flex-column col-sm-9 " style="padding: 0">
                                ...
                                <span style="padding-right: 20px;margin-left: 20px">
                                   <c:if test="${rep.username eq username }">
                                    <span id="delete"> <a href="#" id="${ rep.replay_id}"><img src="img/newic/delete.png" class="img-fluid" alt="删除" style="width: 25px;height: 25px;"></a></span>
                                   </c:if>
                                   </span>
                                    <span style="padding-right: 20px;margin-left: 20px">
                                       
                                        <span id="fabulous"><a href="#" id="${rep.re_repaly_id}" data-id="${rep.replay_id }"> <img src="img/newic/dz.png" class="img-fluid" alt="点赞" style="width: 25px;height: 25px;"> ${rep.fabulous } </a></span>
                                       
                                      
                                    </span>
                                    <span style="padding-right: 20px;margin-left: 20px">
                                      <span id="show"><a class="zan float-right" href="" data-src="#discord" class="view-number" data-toggle="collapse" data-rep_name="${rep.username }" data-rep_id="${rep.replay_id }" data-username="${ username }"  data-anw_id="${rep.answer_id }" data-user_id="${user_id }" data-theme="${theme}" data-question_id="${q_id}"> <img src="img/newic/liaotian.png" class="img-fluid" alt="讨论" style="width: 25px;height: 25px;"> </a></span>
